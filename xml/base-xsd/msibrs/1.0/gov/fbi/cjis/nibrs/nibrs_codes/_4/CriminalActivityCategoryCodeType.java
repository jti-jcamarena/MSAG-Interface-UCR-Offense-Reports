...
/**
 * A data type for the activity type.
 * 
 * <p>Java class for CriminalActivityCategoryCodeType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="CriminalActivityCategoryCodeType"&gt;
 *   &lt;simpleContent&gt;
 *     &lt;extension base="&lt;http://fbi.gov/cjis/nibrs/nibrs-codes/4.2&gt;CriminalActivityCategoryCodeSimpleType"&gt;
...
@XmlType(name = "CriminalActivityCategoryCodeType", namespace = "http://fbi.gov/cjis/nibrs/nibrs-codes/4.2", propOrder = {
    "value"
})
public class CriminalActivityCategoryCodeType {

    @XmlValue
    protected CriminalActivityCategoryCodeSimpleType value;
    ...
    /**
     * A data type for a code that identifies additional information on criminal
     *         activity of offenders in the offense.
     * 
     * @return
     *     possible object is
     *     {@link CriminalActivityCategoryCodeSimpleType }
     *     
     */
    public CriminalActivityCategoryCodeSimpleType getValue() {
        return value;
    }
     ...
     *     
     */
    public void setValue(CriminalActivityCategoryCodeSimpleType value) {
        this.value = value;
    }
