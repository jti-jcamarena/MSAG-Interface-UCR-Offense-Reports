...
import gov.fbi.cjis._1.SubjectAugmentationType;
...
@XmlType(name = "AugmentationType", namespace = "http://release.niem.gov/niem/structures/3.0/")
@XmlSeeAlso({
    gov.fbi.cjis._1.IncidentAugmentationType.class,
    gov.fbi.cjis._1.OrganizationAugmentationType.class,
    SubjectAugmentationType.class,
    gov.niem.release.niem.domains.jxdm._5.IncidentAugmentationType.class,
    gov.niem.release.niem.domains.jxdm._5.OrganizationAugmentationType.class
})
