...
@XmlType(name = "AssociationType", namespace = "http://release.niem.gov/niem/structures/3.0/", propOrder = {
    "associationAugmentationPoint"
})
@XmlSeeAlso({
    gov.niem.release.niem.niem_core._3.AssociationType.class
})
public abstract class AssociationType {

    @XmlElement(name = "AssociationAugmentationPoint", namespace = "http://release.niem.gov/niem/structures/3.0/")
